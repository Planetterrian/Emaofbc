...
export default function MemberAssistantPage() {
  ...
  async function send(text: string) {
    ...
    try {
      ...
      const response = await queryMemberAssistant(content, '', history);
      setMessages((prev) => [
        ...prev,
      ...
      <section className="bg-forest-gradient text-white">
        <div className="container-px py-12 md:py-16">
          ...
          <p className="mt-4 max-w-2xl text-lg text-white/80">
            Ask anything about events, membership, PD credits, and the organization — answered from live EMA data.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-px max-w-3xl">
          ...
          <p className="mt-4 text-center text-xs text-ink-soft">
            AI responses use live EMA data but can occasionally be inaccurate. For billing or account issues, contact
